...
for graph_num in range(10):
    ...
    # Write to file
    filename = f'test_cases/big_graphs/test_1_{n}.txt'
    ...
    # Write to file
    filename = f'test_cases/big_graphs/test_2_{n}.txt'
    with open(filename, "w") as test_file:
        test_file.write(f'{len(vertices)} {len(edges)}\n')
        for u, v, w in edges:
            test_file.write(f'{u} {v} {w}\n')
    ...
    # Write to file
    filename = f'test_cases/big_graphs/test_3_{n}.txt'
    with open(filename, "w") as test_file:
        test_file.write(f'{len(vertices)} {len(edges)}\n')
        for u, v, w in edges:
            test_file.write(f'{u} {v} {w}\n')
    ...
    # Write to file
    filename = f'test_cases/big_graphs/test_4_{n}.txt'
    with open(filename, "w") as test_file:
        test_file.write(f'{len(vertices)} {len(edges)}\n')
        for u, v, w in edges:
            test_file.write(f'{u} {v} {w}\n')
